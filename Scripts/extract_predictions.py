...
FILES = [
    ...
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops1.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops2.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops3.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops4.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops5.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops6.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops7.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops8.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops9.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops10.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops11.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops12.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops13.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops14.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops15.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops16.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops17.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops18.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops19.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops20.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops21.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops22.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops23.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops24.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops25.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops26.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops27.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops28.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops29.txt",
    BASE + "/Benchmark synchronous simulation FW/bench_fw_MASTER_larger_simulation_MYB46_hops30.txt",
