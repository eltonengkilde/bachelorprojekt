...
# EXPLANATION FOR THE ANALYIS:
# 1) What directly regulates the target (KG facts)
# 2) Which upstream genes alone can switch it ON (sufficiency)?
# 3) Which of those direct regulaters is the target actually dependent on? (necessity/knowkout)
